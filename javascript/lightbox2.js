let currentMedia = Array.from(document.getElementsByClassName('mediaForLightbox'));
console.log(currentMedia)
let currentMediaName = Array.from(document.getElementsByClassName('photograph-title'));
console.log(currentMediaName)
let initLightbox = document.getElementsByClassName('mediaForLightbox')
initLightbox.addEventListener('click', () => {
    ...
    class LightBox {
        ...
        init(currentMedia, currentMediaName) {
            let getMedias = Array.from(document.getElementsByClassName('mediaForLightbox')); //ok
